...
#
# Script generated by Vivado on Tue May 06 18:40:13 +0800 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : MOLESCREEN.sh
...
#
# Usage        : MOLESCREEN.sh
#                MOLESCREEN.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                MOLESCREEN.sh [-reset_run]
#                MOLESCREEN.sh [-reset_log]
#                MOLESCREEN.sh [-help]
#
...
# script info
echo -e "MOLESCREEN.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./MOLESCREEN.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot MOLESCREEN xil_defaultlib.MOLESCREEN xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim MOLESCREEN -key {Behavioral:sim_1:Functional:MOLESCREEN} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb MOLESCREEN.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./MOLESCREEN.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: MOLESCREEN.sh [-help]\n\
Usage: MOLESCREEN.sh [-step]\n\
Usage: MOLESCREEN.sh [-lib_map_path]\n\
Usage: MOLESCREEN.sh [-reset_run]\n\
Usage: MOLESCREEN.sh [-reset_log]\n\
Usage: MOLESCREEN.sh [-keep_index]\n\
Usage: MOLESCREEN.sh [-noclean_files]\n\n\
