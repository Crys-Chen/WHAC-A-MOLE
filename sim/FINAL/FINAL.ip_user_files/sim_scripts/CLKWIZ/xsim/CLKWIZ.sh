...
#
# Script generated by Vivado on Tue May 06 18:35:10 +0800 2025
...
#
# Usage        : CLKWIZ.sh
#                CLKWIZ.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                CLKWIZ.sh [-reset_run]
#                CLKWIZ.sh [-reset_log]
#                CLKWIZ.sh [-help]
#
...
# script info
echo -e "CLKWIZ.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./CLKWIZ.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot CLKWIZ xil_defaultlib.CLKWIZ xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim CLKWIZ -key {Behavioral:sim_1:Functional:CLKWIZ} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb CLKWIZ.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./CLKWIZ.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: CLKWIZ.sh [-help]\n\
Usage: CLKWIZ.sh [-step]\n\
Usage: CLKWIZ.sh [-lib_map_path]\n\
Usage: CLKWIZ.sh [-reset_run]\n\
Usage: CLKWIZ.sh [-reset_log]\n\
Usage: CLKWIZ.sh [-keep_index]\n\
Usage: CLKWIZ.sh [-noclean_files]\n\n\
