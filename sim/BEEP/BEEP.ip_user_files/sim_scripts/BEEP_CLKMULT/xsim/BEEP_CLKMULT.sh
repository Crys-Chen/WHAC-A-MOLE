...
#
# Script generated by Vivado on Tue May 06 13:33:14 +0800 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : BEEP_CLKMULT.sh
...
#
# Usage        : BEEP_CLKMULT.sh
#                BEEP_CLKMULT.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                BEEP_CLKMULT.sh [-reset_run]
#                BEEP_CLKMULT.sh [-reset_log]
#                BEEP_CLKMULT.sh [-help]
#
...
export RDI_DATADIR="E:/Apps/Manual/Vivado/Vivado/2024.2/data"

# set xvlog options
xvlog_opts="--incr --relax "

# script info
echo -e "BEEP_CLKMULT.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./BEEP_CLKMULT.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot BEEP_CLKMULT xil_defaultlib.BEEP_CLKMULT xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim BEEP_CLKMULT -key {Behavioral:sim_1:Functional:BEEP_CLKMULT} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/Apps/Manual/Vivado/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb BEEP_CLKMULT.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./BEEP_CLKMULT.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: BEEP_CLKMULT.sh [-help]\n\
Usage: BEEP_CLKMULT.sh [-step]\n\
Usage: BEEP_CLKMULT.sh [-lib_map_path]\n\
Usage: BEEP_CLKMULT.sh [-reset_run]\n\
Usage: BEEP_CLKMULT.sh [-reset_log]\n\
Usage: BEEP_CLKMULT.sh [-keep_index]\n\
Usage: BEEP_CLKMULT.sh [-noclean_files]\n\n\
